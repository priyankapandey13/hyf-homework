...
console.log(`===========================================================`)
  ...
  const movies = [
    ...
    {"title": "'71 summers","year": 2014,"rating": 7.2,"votes": 41702,"running_times": 5940},
    {"title": "'A' gai wak alien","year": 1983,"rating": 7.4,"votes": 11942,"running_times": 6300},
    {"title": "'Breaker' Morant surfer","year": 1980,"rating": 7.9,"votes": 10702,"running_times": 6420},
    {"title": "'Crocodile' Dundee II","year": 1988,"rating": 5.5,"votes": 47180,"running_times": 6480},
    {"title": "(500) Days of Summer of 2009","year": 2009,"rating": 7.7,"votes": 412368,"running_times": 5700},
    {"title": "*batteries not included","year": 1987,"rating": 6.6,"votes": 25636,"running_times": 6360},
    {"title": " tu vivrai nel terrore! L'aldilà","year": 1981,"rating": 6.9,"votes": 16484,"running_times": 5220},
    {"title": "Truth and justice for all.","year": 1979,"rating": 7.4,"votes": 25408,"running_times": 7140},
    ...
    {"title": "10 Items or Less then 10","year": 2006,"rating": 2.7,"votes": 13342,"running_times": 4920},
...
// ===================================================================================================================  No 3 :
    ...
    console.log(`=========================================================== Movies between 1980-1989 year`)
...
// ===================================================================================================================  No 4 :
    ...
    console.log(`=========================================================== Created tag for rating`)
...
// ===================================================================================================================  No 5 :
    ...
    console.log(`===========================================================movies rated higher than 6`)
    let moviename=[];
    let movratings=[];
    const higherthen6 = movies.filter(item => item.rating>6).map(item => item.rating)    
    //                      ?????????????????????????????????????????????????????????????????????????????????????????????? why it is not working
    // movies.forEach(element => {
    //     element.rating.value > 6;
    //     moviename.push(element.title)
    // })
...
// ===================================================================================================================  No 6 : count the total number of movies
    ...
    console.log(`The total number of movies containing Surfer, Alien or Benjamin are ${i}`)
...
// ===================================================================================================================  No 7 +8
    ...
    console.log(`=========================================================== word in the title is duplicated`)
...
console.log(`=========================================================== Calculate the average rating`)
...
console.log(`=========================================================== Count total of Good, Average and Bad movies`)
    
    let results = movies.map((item) =>{item.rating = Math.floor(item.rating) // let result
