...
const addreservation = function (request, response) {
  ...
  pool.query("INSERT INTO reservation SET ?", values, function (
    error,
    results,
    fields
  ) {
...
const returnReservationsById = function (request, response) {
  ...
  pool.query("SELECT * FROM reservation WHERE id = ?", values, function (
    error,
    results,
    fields
  ) {
...
const deleteReservationsById = function (request, response) {
  ...
  pool.query("DELETE FROM reservation WHERE id = ?", idval, function (
    error,
    results,
    fields
  ) {
