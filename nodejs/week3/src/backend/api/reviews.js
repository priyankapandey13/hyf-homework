...
const addreview = function (request, response) {
  ...
  pool.query("INSERT INTO review SET ?", values, function (
    error,
    results,
    fields
  ) {
...
const returnreviewsById = function (request, response) {
  ...
  pool.query("SELECT * FROM review WHERE id = ?", values, function (
    error,
    results,
    fields
  ) {
...
const updatereviewsById = function (request, response) {
  ...
  pool.query("UPDATE review SET ? WHERE id = ?", [values, idval], function (
    error,
    results,
    fields
  ) {
...
const deletereviewsById = function (request, response) {
  ...
  pool.query("DELETE FROM review WHERE id = ?", idval, function (
    error,
    results,
    fields
  ) {
